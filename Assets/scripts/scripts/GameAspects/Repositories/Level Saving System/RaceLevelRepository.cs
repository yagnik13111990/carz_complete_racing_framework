...
public class RaceLevelRepository : ILevelRepository
{
    private string FilePath => "GameJsonDataFiles/SimpleRaceLevelDatabase.json";
    public Dictionary<int, LevelData> LoadLevelData()
    {
        try
        {
            ...
            return JsonConvert.DeserializeObject<Dictionary<int, LevelData>>(json) ?? new Dictionary<int, LevelData>();
        }
